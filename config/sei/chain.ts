...
export const FACTORY_ADDRESS = "0x71f6b49ae1558357bBb5A6074f1143c46cBcA03d".toLowerCase();

export const REFERENCE_TOKEN = "0xE30feDd158A2e3b13e9badaeABaFc5516e95e8C7".toLowerCase(); // WSEI
...
].map(a => a.toLowerCase()); // Add actual stable token pairs when available
