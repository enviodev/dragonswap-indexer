...
// Pricing and data quality constants (keeping business logic, removing artificial whitelisting)
...
// Whitelist for pricing accuracy (not scaling limitations)
// These tokens are used as reliable pricing sources in findEthPerToken
...
// Stablecoins for pricing calculations
// These tokens are used to calculate stablecoin ETH values
export const STABLECOINS: string[] = [];

// Minimum thresholds for data quality (keeping business logic, not scaling limitations)
export const MINIMUM_USD_THRESHOLD_NEW_PAIRS = new BigDecimal('400000');
export const MINIMUM_LIQUIDITY_THRESHOLD_ETH = new BigDecimal('2');
